...
if (filter_input(INPUT_POST, 'nom') && filter_input(INPUT_POST, 'siren') &&
    ...
    if (Fonctions::existSiren(filter_input(INPUT_POST, 'siren'))) {
        header("Location:societe_form.php?form=siren_exist");
    } else {
