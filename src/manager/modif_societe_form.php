...
<form action="update_societe.php" method="post" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="avad_soc" value="<?php echo $societe['avad_soc']; ?>" class="form-control" id="avad_soc" required placeholder="Conseil">
        </div>
    </div>
    <div class="form-group">
        <label for="bonis_soc" class="col-sm-2 control-label">Type de la société</label>
        <div class="col-sm-10">
            <input type="text" name="bonis_soc"  value="<?php echo $societe['bonis_soc']; ?>" class="form-control" id="bonis_soc" required placeholder="status">
        </div>
    </div>
    <div class="form-group">
